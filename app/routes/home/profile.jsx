...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
    Outside of coding, I enjoy travelling, solving puzzles and brain teasers, and music. I also like reading about personal growth and staying curious about how things work.
